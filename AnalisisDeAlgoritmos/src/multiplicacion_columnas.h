 ...
 * @date: 11/02/2025
 * @brief Estrategia de multiplicación de matrices por columnas
*/
...
class MultiplicacionColumnas : public MatrizMultiplicacionEstrategia {
public:

  /**
   * @brief Multiplica dos matrices por columnas
   * @param A Matriz A
   * @param B Matriz B
