 ...
 * @date: 18/02/2025
 * @brief implementacion de la clase Jzero
*/

#include "jzero.h"

/**
 * @brief ejecuta la instrucción jzero
 * @param contexto contiene la memoria de datos, el contador de programa, 
 *        la unidad de salida y la unidad de entrada
 */
void Jzero::ejecutar(Contexto& contexto) {
...
/**
 * @brief parsea la instrucción jzero
 * @param instruccion contiene la instrucción a parsear
 */
void Jzero::parsear(std::string& instruccion) {
