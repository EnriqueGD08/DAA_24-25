 ...
 * @date: 18/02/2025
 * @brief: implementacion clase InstruccionMOD
*/
...
/**
 * @brief Método que ejecuta la instrucción MOD
 * @param contexto: contexto de la máquina RAM
 */
void InstruccionMOD::ejecutar(Contexto& contexto) {
...
/**
 * @brief Método que parsea la instrucción MOD
 * @param instruccion: string que contiene la instrucción
 */
void InstruccionMOD::parsear(std::string& instruccion) {
