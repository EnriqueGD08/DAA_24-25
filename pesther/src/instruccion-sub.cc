 ...
 * @date 14 Feb 2024
 * @brief Implementación de la clase "InstruccionSUB"
 ...
 */
void InstruccionSUB::ejecutar(Contexto& contexto) {
  #ifdef DEPURAR
  std::cout << "Ejecutando instrucción SUB..." << std::endl;
  #endif
 ...
 */
void InstruccionSUB::parsear(std::string& instruccion) {
  #ifdef DEPURAR
  std::cout << "Parseando instrucción SUB..." << std::endl;
  #endif
 ...
 */
std::ostream& InstruccionSUB::write(std::ostream& os, bool debug) const {
  if (debug) {
    os << "\nOpcode: " << opcode_;
