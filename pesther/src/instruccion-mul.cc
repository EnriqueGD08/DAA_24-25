 ...
 * @date 14 Feb 2024
 * @brief Implementación de la clase "InstruccionMULT"
 ...
 */
void InstruccionMULT::ejecutar(Contexto& contexto) {
  #ifdef DEPURAR
  std::cout << "Ejecutando instrucción MUL..." << std::endl;
  #endif
 ...
 */
void InstruccionMULT::parsear(std::string& instruccion) {
  #ifdef DEPURAR
  std::cout << "Parseando instrucción MUL..." << std::endl;
  #endif
 ...
 */
std::ostream& InstruccionMULT::write(std::ostream& os, bool debug) const {
  if (debug) {
    os << "\nOpcode: " << opcode_;
